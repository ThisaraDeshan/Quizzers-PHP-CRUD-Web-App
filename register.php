...
<html>
	<head>
		...
		<title>Register | Quizzers.Com</title>
	...
	<nav class="navbar bg-light">
  		<div class="container-fluid">
    		<a class="navbar-brand" href="www.Quizzers.Com">Quizzers.Com</a>
  		</div>
	</nav>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Quizzers.Com</h4></center><br>
